...
def main():
    ...
    parser.add_argument('-l', '--language', help="English (en), Dutch (nl), or Chinese (ch)", default='en')
    ...
    if lang == 'en':
        ...
        print("Reading file for GECO_NL: ", reading_data_fn)
        ...
        print("Reading file for GECO_NL: ", sentence_info_fn)
        ...
        task =  "geco_nl"
    # elif lang == 'ch':
    #     reading_data_fn = "data/geco_ch/raw/L1ReadingData.xlsx"
    ...
    #     sentence_info_fn = "data/geco_ch/raw/ChineseMaterials.xlsx"
